...
public interface ConsultationMapper {
  ...
  Consultation selectConsultationByDoctorIdAndUserId(
  ...
  @Insert(
      "INSERT INTO c_consultations(user_id, doctor_id, consultation_start, consultation_end, rating)"
  ...
  // 更新咨询记录
  @Update(
      "UPDATE c_consultations SET doctor_id = #{doctorId}, user_id = #{userId}, consultation_start = #{consultationStart}, "
