...
public interface ParentChildRelationMapper {
  ...
  // 插入新关系
  @Insert(
      "INSERT INTO u_parents_children(relation_id, user_id, child_id, relation_type, created_at) "
  ...
  @Select(
      "SELECT * FROM u_children WHERE child_id IN "
